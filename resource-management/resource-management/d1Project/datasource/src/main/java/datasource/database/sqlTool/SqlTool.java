package datasource.database.sqlTool;
...
import datasource.database.connector.DatabaseConnectorFactory;
import datasource.database.template.DatabaseTemplateFactory;
import datasource.database.template.IDatabaseTemplate;
...
public class SqlTool implements Closeable {
     ...
     * @throws Exception
     */
    public JSONArray getColumns(String tableName) throws Exception {
        JSONArray array = new JSONArray();
        //获取指定表的所有字段
        try {
            //获取查询指定表所有字段的sql语句
            String querySql = databaseTemplate.getSQLQueryFields(tableName);
