package d1.project.resource.group.service;

import d1.project.resource.group.dao.GroupInfoDao;
...
public class GroupInfoService {
    ...
    public List<GroupInfo> findAllByTypeOrderByCreateTimeAsc(String type) {
        return groupInfoDao.findAllByTypeOrderByCreateTimeAsc(type);
    }
