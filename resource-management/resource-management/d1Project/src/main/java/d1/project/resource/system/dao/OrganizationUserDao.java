package d1.project.resource.system.dao;

import d1.project.resource.system.entity.OrganizationUserEntity;
...
public interface OrganizationUserDao extends JpaRepository<OrganizationUserEntity, String>, JpaSpecificationExecutor<OrganizationUserEntity> {
    ...
    @Query(value = "select new d1.project.resource.system.model.vm.WebAdminUserBaseVm(waue.id, waue.name, waue.phone, waue.account, waue.organizationName, waue.roleName) " +
