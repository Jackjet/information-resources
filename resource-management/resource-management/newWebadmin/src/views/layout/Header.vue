<template>
  <div class="theHeader">
    ...
    <div class="right-menu" style="display:flex;">
      <span @click='goBack()' style="margin-right:20px;display:flex;align-items:center;cursor:pointer"><img width="30" height="30" src="../../assets/image/goBack.png" alt="" style="margin-top:-4px;"><span style="margin-left:5px;color:#616266">返回首页</span></span>
        ...
        <div class="avatar-wrapper">
          <svg t="1600311663297" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5329" width="35" height="40">
            <path
              ...
              p-id="5330" fill="#314790"></path>
            <path d="M512 401m-106 0a106 106 0 1 0 212 0 106 106 0 1 0-212 0Z" p-id="5331" fill="#314790"></path>
            <path d="M514.5 540.8c-105.1 0-195 68.8-231.6 166.2 28.2 27.9 60.4 50.1 95.9 65.9 40.2 18 83 27.1 127.1 27.1s86.9-9.1 127.1-27.1c38.9-17.4 73.8-42.3 103.8-74.1 1.4-1.5 2.7-3 4.1-4.4-39.2-90.6-125.8-153.6-226.4-153.6z" p-id="5332" fill="#314790"></path>
          </svg>
...
import { updatePassword } from '@/api/withoutIpRequest'
export default {
  name: 'MyHeader',
  data() {
    return {
  ...
  methods: {
    ...
    clickMenu(item) {
      ...
      this.routerData.splice(0)
      console.log(this.routerData, "111111")
      sessionStorage.setItem("theBreadcrumb2", JSON.stringify(this.routerData))
    ...
    toDoLogout() {
      ...
      // this.$router.push('http://39.102.73.127/userManagement/#/login')
      // window.location.href = process.env.VUE_APP_USER_LOGIN
      location.reload();
    },
    openDialog() {
    ...
    goBack() {
      // 集成登录返回首页
      window.location.href = process.env.VUE_APP_NAV_API
      // 正常登录返回首页
      // window.location.href = process.env.VUE_APP_USER_BACK
    }
  },
  watch: {
    // 监听路由变化
