      ...
      <el-col :span="8" class="el-col_left">
              ...
              <el-table :data="records" style="width: 100%" :show-header="false">
                <el-table-column type="expand" prop="id">
                  <template slot-scope="props">
                    <el-table :data="props.row.sourceApiTestRecords" :show-header="false">
                      <el-table-column prop="method" width="75px">
                      </el-table-column>
                      <el-table-column prop="responseCode" width="88px">
                        <template slot-scope="scope">
                          状态：{{scope.row.responseCode}}
                        </template>
                      </el-table-column>
                      <el-table-column prop="responseTime" width="55px">
                        <template slot-scope="scope">
                ...
                <el-table-column prop="requestDay">
                </el-table-column>
              </el-table>
            </div>
          </el-col>
        ...
        <el-row v-if="active === 'testCase'">
          <el-col :span="16" :offset="8">
            <el-upload class="upload-demo" :action="action" :headers="headers" :file-list="fileList" multiple="false" :on-success="handleFileUploadSuccess" :before-upload="beforeUpload">
        ...
        <el-row v-if="active === 'testCase'">
          <el-col :span="24">
            <el-table :data="testcase" style="width: 100%" :show-header="false">
              <el-table-column type="expand" prop="id">
                <template slot-scope="props">
                  <el-table ref="singleTable" :data="props.row.sourceApiTestCases" :show-header="false" highlight-current-row @current-change="rowClick">
              ...
              <el-table-column prop="createDay">
              </el-table-column>
            </el-table>
        ...
        <el-row>
          <el-col :span="24">
            <el-tabs active-name="other">
              <el-tab-pane label="源API测试参数" disabled></el-tab-pane>
              <!--              占位-->
...
<script>
import { findAllRecordGroup, findAllTestCaseGroup, deleteTestCase, downloadTestCase, addTestCase, insertTestResult, sourceApiTestRecordDelete } from "@/api/sourceApiTest"
