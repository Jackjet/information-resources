...
export default{
    ...
    created(){
        if(this.$route.query.dataBaseName){
            localStorage.setItem('dataUnit',JSON.stringify(this.$route.query))
        }
        this.query = JSON.parse(localStorage.getItem('dataUnit'))
        const that = this
        that.dataSourceId = that.query.dataSourceId
        that.dataBaseName = that.query.dataBaseName
