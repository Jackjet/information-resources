<template>
  <div class="theHeader">
    ...
    <div class="right-menu">
      <el-dropdown placement="bottom-start" style="cursor:pointer" class="avatar-container" trigger="click">
        ...
        <el-dropdown-menu style="margin-top: 10px;cursor:pointer" slot="dropdown" class="user-dropdown">
...
export default {
  ...
  methods: {
    ...
    // 点击路由对应面包屑
    clickRouter(item) {
      console.log(item, this.routerData)
      if (this.$route.path === item.path) {
        return false
      }
      let theIndex = ''
      ...
      this.$refs["ruleForm"].validate(async (valid) => {
        if (valid) {
          ...
          const data = {
            ...
            textPassword: that.ruleForm.newPassword
          }
          try {
