<template>
  <el-main class="main">
    <el-col :span="24">
      <el-form :inline="true" class='el-InputForm'>
        ...
        <el-form-item label="组织机构">
          <el-input clearable size="medium" placeholder="请输入组织机构" v-model="SearchItem.organizationName">
          </el-input>
        </el-form-item>
    ...
    <el-col :span="24" style="margin-top: 10px;">
      ...
      <el-button type="primary" plain size='mini' @click="synchronizationUser" icon="el-icon-refresh">同步用户</el-button>
    </el-col>
    <el-col :span='24'>
