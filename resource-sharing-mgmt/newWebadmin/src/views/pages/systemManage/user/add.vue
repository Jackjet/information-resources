  ...
  <el-main class="main">
    ...
    <el-col class="main-center">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm" v-loading="loading">
        ...
        <el-form-item label="账号:" :label-width="this.formLabelWidth" :prop="disabledo?'':'account'">
        ...
        <el-form-item label="身份证:" :label-width="this.formLabelWidth">
          <el-input maxlength='100' placeholder="请输入身份证" clearable size="medium" :disabled="disabled" v-model="ruleForm.idCard" />
        </el-form-item>
        ...
        <el-form-item label="组织机构:" :label-width="this.formLabelWidth" prop='organizationId'>
          <el-cascader style="width: 100%;" :placeholder="organizationMsg" :props="props" :disabled="disabled" collapse-tags clearable v-model="ruleForm.organizationId" :options="organizationOptions" />
        </el-form-item>
        ...
        <!-- <el-form-item label="系统权限:" :label-width="this.formLabelWidth" prop="sysList">
          <el-checkbox-group v-model="ruleForm.sysList">
            <el-checkbox label="系统运维管理">系统运维管理</el-checkbox>
            <el-checkbox label="资源交换管理系统">资源交换管理系统</el-checkbox>
            <el-checkbox label="数据质量分析系统">数据质量分析系统</el-checkbox>
            <el-checkbox label="资源目录管理系统">资源目录管理系统</el-checkbox>
            <el-checkbox label="资源共享管理系统">资源共享管理系统</el-checkbox>
          </el-checkbox-group>
        </el-form-item> -->
...
import { webAdminUserFind, webAdminUserInsert, webAdminUserUpdate, sysRoleInsert, sysRoleFindAll } from "@/api/userMen.js";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        //   trigger: ['change', 'blur']
        // }, {
        //   pattern: /^(1[3|4|5|6|7|8|9])\d{9}$|^0\d{2,3}-?\d{7,8}$/g,  //正则
        //   message: '请输入正确的手机号'
        // }],
        idCard: [{
          required: true,
      ...
      headers: {
        Authorization: 'token ' + JSON.parse(getCookies("userInfo")).token,
      },
  ...
  methods: {
    ...
    async userDetail() {
      ...
      if (response.data.code === 1) {
        ...
        const response1 = await sysRoleFindAll({ account: that.ruleForm.account })
        this.ruleForm.sysList = JSON.parse(response1.data.data)
      } else {
        // 添加上传失败后 回调失败信息
      ...
      this.$refs["ruleForm"].validate((valid) => {
        if (valid) {
          ...
          let obj = {
            ...
            value: JSON.stringify(data.sysList)
          }
          delete data['sysList']
