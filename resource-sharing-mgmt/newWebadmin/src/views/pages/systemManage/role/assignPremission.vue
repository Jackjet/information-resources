        ...
        <el-form label-width="120px">
          <el-row class='el-row-el ele-tree ml' v-if="dataArray.length">
            ...
            <el-form-item class="el-button-el" label="角色权限名称:" :label-width="this.formLabelWidth">
              <el-input clearable style="width: 220px;" :disabled="true" size="medium" placeholder="请输入角色权限名称" v-model="name">
              </el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    renderContent(h, { node, data }) {
      ...
      // 懒加载图标设置
      dom = (
        <p class="custom-tree-node" style="justify-content: left;">
    ...
    async getList() {
      ...
      try {
        ...
        if (response.data.code === 1) {
          ...
          let arrTree = JSON.stringify(arr)
