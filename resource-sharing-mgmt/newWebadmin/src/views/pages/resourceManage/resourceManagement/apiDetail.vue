    ...
    <el-col class="main-center">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
        ...
        <el-form-item label="接口方式:" :label-width="this.formLabelWidth">
          <el-input maxlength="100" placeholder="" clearable size="medium" :disabled="true" v-model="ruleForm.method"></el-input>
        </el-form-item>
        <el-form-item label="请求参数部分说明:" :label-width="this.formLabelWidth">
          <el-input maxlength="100" placeholder="" clearable size="medium" :disabled="true" v-model="httpUrl"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    goBack() {
      // this.$router.push( '/archBusiUviewAdd');
      this.$router.go(-1);
    }
  },
};
