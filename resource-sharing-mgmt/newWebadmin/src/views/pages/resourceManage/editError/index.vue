  ...
  <el-main class="main">
    <el-col :span="24">
      <el-form :inline="true" class="el-InputForm">
        <el-form-item>
          <el-cascader size="medium" placeholder="请选择纠错单位" :props="props" collapse-tags clearable v-model="SearchItem.correctionOrgId" :options="organizationOptions" getCheckedNodes />
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    ...
    async fetchData(type) {
      ...
      data.orgId = JSON.parse(getCookies('userInfo')).organizations[0];

      if (this.SearchItem.correctionOrgId != '') {
        data.correctionOrgId = this.SearchItem.correctionOrgId[this.SearchItem.correctionOrgId.length - 1];
      }
      if (type !== 'page') {
