    ...
    <el-row :gutter="15" class="panel-group">
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('newVisitis')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">申请单位数</div>
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('messages')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">资源使用总计</div>
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('purchases')">
          ...
          <div class="card-panel-description">
            <div class="card-panel-text">审核通过数</div>
...
import {
  getResourceUseCountAnalysis,
  getResourceUseCountByType,
  getResourceUseByMonth,
  getResourceUseByPassRate
} from "@/api/summary.js";
...
export default {
  ...
  created() {
    getResourceUseCountAnalysis().then(res => {
      if (res.data.code === 1) {
    ...
    getResourceUseCountByType().then(res => {
      if (res.data.code === 1) {
        this.echartsFun1(res.data.data);
      }
    })
    getResourceUseByMonth().then(res => {
      if (res.data.code === 1) {
        let datas = {
          month: [],
          num: []
        ...
        res.data.data.forEach(item => {
          datas.month.push(item.month)
          datas.num.push(item.num)
        })
        this.echartsFun2(datas);
      }
    })
    getResourceUseByPassRate().then(res => {
      if (res.data.code === 1) {
