      ...
      <el-form :inline="true" class='el-InputForm'>
        ...
        <el-form-item>
          <!-- <el-input clearable
                    size="medium"
                    placeholder="请输入受理部门"
                    v-model="SearchItem.acceptDept">
          </el-input> -->
          <el-cascader size="medium" placeholder="请选择受理部门" :props="props" collapse-tags clearable v-model="SearchItem.acceptDept" :options="organizationOptions" />
        </el-form-item>
        <el-form-item>
          <el-select clearable v-model="SearchItem.status" placeholder="请选择需求状态">
...
export default {
  ...
  methods: {
    ...
    async fetchData() {
      ...
      if (typeof (data.acceptDept) != 'string' && typeof (data.acceptDept) != 'undefined') {
        data.acceptDept = data.acceptDept[data.acceptDept.length - 1]
      }
