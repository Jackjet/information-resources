...
public interface IWebAdminUserService {
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    List<WebAdminUserEntity> updateAllEnable(WebAdminUserUpdateAllEnableVm model, HttpServletRequest request) throws Exception;

    /**
     * 更新启用
     */
    @Transactional(rollbackFor = Exception.class)
    WebAdminUserEntity updateEnable(WebAdminUserUpdateEnableVm model, HttpServletRequest request) throws Exception;

    Page<WebAdminUserVm> findAll(WebAdminUserFindAllVm model) throws Exception;

    List<WebAdminUserExcelBase> findAllList(WebAdminUserFindAllVm model) throws Exception;

    List<WebAdminUserEntity> findAllList() throws Exception;

    List<WebAdminUserExcelBase> findAllByIds(List<String> ids) throws Exception;
     ...
     * 返回excel
     */
    void easyExcelWrite(HttpServletResponse response, List<WebAdminUserExcelBase> allList, CellWriteHandler... cellWriteHandlers) throws IOException;

    /**
     * 设置需要下拉的列样式
     * @return
     */
    CellWriteHandler getCellWriteHandler(int dataSize);
     ...
     *
     */
    void sync(HttpServletRequest request) throws Exception;
}
