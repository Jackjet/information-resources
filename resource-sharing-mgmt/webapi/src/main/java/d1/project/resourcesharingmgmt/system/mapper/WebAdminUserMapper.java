package d1.project.resourcesharingmgmt.system.mapper;

import d1.project.resourcesharingmgmt.common.utils.MapperFormatStrategy;
...
import d1.project.resourcesharingmgmt.system.model.vm.WebAdminUserInsertVm;
import d1.project.resourcesharingmgmt.system.model.vm.WebAdminUserUpdateVm;
...
public interface WebAdminUserMapper {
    ...
    List<WebAdminUserExcelBase> entityListFormatIntoExcelDtoList(List<WebAdminUserEntity> insertVm);

    WebAdminUserExcelBase entityFormatIntoExcelDto(WebAdminUserEntity insertVm);
