package d1.project.resourcesharingmgmt;
...
import d1.project.resourcesharingmgmt.resource.service.ApiVisitLogService;
...
public class ScheduleService {
    ...
    public ScheduleService(ArchBusiUviewExBusiness archBusiUviewExBusiness, ApiVisitLogService apiVisitLogService,
    ...
    public void task1() throws Exception {
        archBusiUviewExBusiness.mountFileList(Constants.TS_FILE);
    }
...
//    @Scheduled(cron = "0/5 * * * * ?")
    ...
    public void task4() throws Exception {
        dataAnalysisBusiness.syncFrontDataBaseCount();
    }
}
