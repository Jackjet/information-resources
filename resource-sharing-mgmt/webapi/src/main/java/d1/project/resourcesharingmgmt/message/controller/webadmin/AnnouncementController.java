package d1.project.resourcesharingmgmt.message.controller.webadmin;

import d1.framework.webapi.annotation.Auth;
import d1.framework.webapi.configuration.DoValidException;
import d1.framework.webapi.http.Result;
import d1.framework.webapi.http.ResultUtil;
import d1.project.resourcesharingmgmt.message.entity.AnnouncementEntity;
import d1.project.resourcesharingmgmt.message.model.AnnouncementFindAllVm;
import d1.project.resourcesharingmgmt.message.model.AnnouncementInsertVm;
import d1.project.resourcesharingmgmt.message.model.AnnouncementUpdateVm;
import d1.project.resourcesharingmgmt.message.service.AnnouncementService;
