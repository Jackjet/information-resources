...
public class Constants {
    ...
    public final static String FILE = FILES_ROOT + "file" + File.separator;

    public final static String TS_FILE = FILE + "ts" + File.separator;

    public final static String DEMANDED_IS_NOT_USER = "该需求非当前用户提交";
    public final static String DEMANDED_IS_ACCEP = "需求已经受理";
    public final static String DEMANDED_IS_EXIST = "需求已存在,请勿重复提交";

    public final static String RESOURCE_IS_NOT_USER = "云接口资源非当前用户提交";
    public final static String RESOURCE_IS_ACCEP = "云接口资源已经受理";
    public final static String RESOURCE_IS_EXIST = "云接口资源已存在";
}
