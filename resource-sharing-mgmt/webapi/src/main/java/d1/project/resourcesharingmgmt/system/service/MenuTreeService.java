...
import d1.project.resourcesharingmgmt.system.dao.MenuTreeDao;
import d1.project.resourcesharingmgmt.system.dao.RoleMenuTreeDao;
import d1.project.resourcesharingmgmt.system.entity.MenuTreeEntity;
import d1.project.resourcesharingmgmt.system.mapper.MenuTreeMapper;
...
public class MenuTreeService {
    ...
    public void insert(MenuTreeInsertVm model, HttpServletRequest request) throws DoValidException {
        ...
        if (menuTree.getLevel() > 3) {
            throw new DoValidException("菜单最多可建四级菜单");
        }
