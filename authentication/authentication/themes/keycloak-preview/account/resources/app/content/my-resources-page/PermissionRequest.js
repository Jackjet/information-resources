...
var PermissionRequest = /** @class */ (function (_super) {
    ...
    function PermissionRequest(props) {
        ...
        _this.handleApprove = function (username, scopes) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.handle(username, scopes, true);
                return [2 /*return*/];
            });
        }); };
        _this.handleDeny = function (username, scopes) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        _this.handle = function (username, scopes, approve) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var id, permissionsRequest, userScopes, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            id = this.props.resource._id;
                            this.handleToggleDialog();
                            return [4 /*yield*/, account_service_1.AccountServiceClient.Instance.doGet("/resources/" + id + "/permissions")];
                        case 1:
                            permissionsRequest = _a.sent();
                            userScopes = permissionsRequest.data.find(function (p) { return p.username === username; }).scopes;
                            if (approve) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, account_service_1.AccountServiceClient.Instance.doPut("/resources/" + id + "/permissions", { data: [{ username: username, scopes: userScopes }] })];
                        case 3:
                            _a.sent();
    ...
    PermissionRequest.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(react_core_1.Modal, { title: 'Permission requests - ' + this.props.resource.name, isLarge: true, isOpen: this.state.isOpen, onClose: this.handleToggleDialog, actions: [
                    React.createElement(react_core_1.Button, { key: "close", variant: "link", onClick: this.handleToggleDialog },
                ...
                React.createElement(react_core_1.DataList, { "aria-label": Msg_1.Msg.localize('permissionRequests') },
                        ...
                        React.createElement(react_core_1.DataListItemCells, { dataListCells: [
                                ...
                                React.createElement(react_core_1.DataListCell, { key: 'permissions-requested-header', width: 5 },
                                    React.createElement("strong", null,
                                        React.createElement(Msg_1.Msg, { msgKey: 'permissions' }),
                                        " requested")),
                    ...
                    this.props.resource.shareRequests.map(function (shareRequest, i) {
                        return React.createElement(react_core_1.DataListItem, { key: i, "aria-labelledby": "requestor" },
                            React.createElement(react_core_1.DataListItemRow, null,
                                React.createElement(react_core_1.DataListItemCells, { dataListCells: [
                                        React.createElement(react_core_1.DataListCell, { key: "requestor" + i },
                                        ...
                                        React.createElement(react_core_1.DataListCell, { key: "permissions" + i }, shareRequest.scopes.map(function (scope, j) { return React.createElement(react_core_1.Chip, { key: j, isReadOnly: true }, scope); })),
                                        React.createElement(react_core_1.DataListCell, { key: "actions" + i },
                                            React.createElement(react_core_1.Button, { onClick: function () { return _this.handleApprove(shareRequest.username, shareRequest.scopes); } }, "Accept"),
                                            React.createElement(react_core_1.Button, { variant: "danger", onClick: function () { return _this.handleDeny(shareRequest.username, shareRequest.scopes); } }, "Deny"))
                                    ] })));
                    })))));
    };
