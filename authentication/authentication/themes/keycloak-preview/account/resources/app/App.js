...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        ...
        var Header = (React.createElement(react_core_1.PageHeader, { logo: React.createElement("a", { id: "brandLink", href: brandUrl },
                React.createElement(react_core_1.Brand, { src: brandImg, alt: "Logo", className: "brand" })), toolbar: React.createElement(PageToolbar_1.PageToolbar, null), avatar: React.createElement(react_core_1.Avatar, { src: avatarImg, alt: "Avatar image" }), showNavToggle: true }));
