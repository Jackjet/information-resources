...
import d1.project.dcrun.center.webapi.task.dao.TaskEntityLogDao;
...
public class TaskEntityLogService {
    ...
    public void end(TaskEntityLogInsertVm taskEntityLogInsertVm) throws Exception {
        Task task = taskDao.findById(taskEntityLogInsertVm.getTaskId()).orElseThrow(() -> new Exception("任务不存在"));
