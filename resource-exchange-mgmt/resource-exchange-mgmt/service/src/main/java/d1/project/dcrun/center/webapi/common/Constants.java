...
public class Constants {
    ...
    public final static String CONTAINER_IS_NULL = "容器不存在";
    public final static String CONTAINER_NAME_REPEAT = "容器名称已存在";
    public final static String CONTAINER_URL_REPEAT = "容器地址已存在";
    public final static String CONTAINER_IS_TASK = "容器已存在任务";
    public final static String CONTAINER_STATUS_ERR = "容器不可用";
    ...
    public final static String DATA_INFO_ERROR = "数据库信息错误无法连接";
    ...
    public final static String TASK_IS_RUN = "警告,任务已运行";
    ...
    public final static String TASK_REPEAT = "任务名已存在";
    public final static String TASK_IS_EXIST = "任务已存在作业，请删除后再导入";
}
