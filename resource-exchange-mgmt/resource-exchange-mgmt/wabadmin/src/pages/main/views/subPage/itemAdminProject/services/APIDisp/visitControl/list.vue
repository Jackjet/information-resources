  ...
  <el-main v-loading="Loading">
    <el-col :span="24">
      ...
      <el-form :inline="true" class='el-InputForm'>
        ...
        <el-form-item>
          <el-select placeholder="请选择动作类型"
            :popper-append-to-body='false'
            clearable v-model="SearchItem.operation"
            size="medium">
...
export default {
  ...
  methods: {
    ...
    async askInfo () {
      const that = this
      try {
        let findUrl = this.Interface.accessStrategy.find
    ...
    delete (row) {
      ...
      that.$confirm('此操作将永久删除数据, 是否继续?', '提示', {
        ...
        let url = this.Interface.accessStrategy.delete
        that.Loading = true
