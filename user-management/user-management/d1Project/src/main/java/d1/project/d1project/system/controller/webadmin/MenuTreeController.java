...
import d1.project.d1project.common.model.OperationLogAspect;
import d1.project.d1project.common.model.OperationLogParametersAspect;
...
import d1.project.d1project.system.service.MenuTreeService;
...
public class MenuTreeController {
     ...
     * 根据系统获取菜单树
     */
    @GetMapping(value = "/findAllBySystem")
    public Result<MenuTreeTree> findAllBySystem(Integer systemCode) {
        return ResultUtil.success("", menuTreeService.findAllFormatIntoVm(systemCode));
    }
    ...
    public Result<MenuTreeTree> findAll() {
        return ResultUtil.success("", menuTreeService.findAllFormatVm());
    }
