...
import d1.project.d1project.system.entity.OrganizationUserEntity;
...
public interface OrganizationUserDao extends JpaRepository<OrganizationUserEntity, String>, JpaSpecificationExecutor<OrganizationUserEntity> {
    ...
    @Query(value = "select new d1.project.d1project.system.model.vm.WebAdminUserBaseVm(waue.id, waue.name, waue.phone, waue.account, waue.organizationName, waue.roleName) " +
