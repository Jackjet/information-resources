...
public class RoleMenuTreeController {
    ...
    public Result<List<String>> findAll(@Valid @NotBlank(message = "角色id不可为空") String roleId,Integer systemCode) {
        return ResultUtil.success("成功", roleMenuTreeService.findAllRoleIdChoose(roleId,systemCode));
