...
public interface MenuTreeDao extends JpaRepository<MenuTreeEntity, String>, JpaSpecificationExecutor<MenuTreeEntity> {
    ...
    boolean existsByNameAndParentIdAndSystemCode(String name, String parentId,Integer systemCode);

    boolean existsByNameAndParentIdAndIdNot(String name, String parentId, String id);

    boolean existsByNameAndParentIdAndSystemCodeAndIdNot(String name, String parentId,Integer systemCode, String id);
    ...
    List<MenuTreeEntity> findAllByIdInAndSystemCodeOrderBySeqAsc(Collection<String> id,Integer systemCode);

    List<MenuTreeEntity> findAllByIdInOrderBySeqAsc(Collection<String> id);

    List<MenuTreeEntity> findAllByIdInAndTypeInAndSystemCodeOrderBySeqAsc(Collection<String> id, Collection<Integer> type,Integer systemCode);
    ...
    List<MenuTreeEntity> findAllBySystemCodeOrderBySeqAsc(Integer systemCode);
}
