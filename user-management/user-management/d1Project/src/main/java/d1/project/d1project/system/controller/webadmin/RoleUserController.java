...
public class RoleUserController {
    ...
    public Result<List<RoleUserMenuTreeVm>> findCurrentUser(Integer systemCode,HttpServletRequest request) throws DoValidException {
        return ResultUtil.success("", roleUserService.findCurrentUser(systemCode,request));
    }

    @GetMapping(value = "/findCurrentUserButton")
    public Result<List<String>> findCurrentUserButton(Integer systemCode,HttpServletRequest request) throws DoValidException {
        return ResultUtil.success("", roleUserService.findCurrentUserButton(systemCode,request));
    }

    @GetMapping(value = "/findCurrentUserSidebar")
    public Result<List<RoleUserMenuTreeVm>> findCurrentUserSidebar(Integer systemCode,HttpServletRequest request) throws DoValidException {
        return ResultUtil.success("", roleUserService.findCurrentUserSidebar(systemCode,request));
    }
}
