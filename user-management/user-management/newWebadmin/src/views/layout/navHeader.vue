<template>
  <div class="theHeader">
    ...
    <div class="right-menu">
      <el-dropdown placement="bottom-start" class="avatar-container" trigger="click" style="cursor:pointer">
        <div class="avatar-wrapper">
          <svg t="1600311663297" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5329" width="35" height="40">
            <path
              ...
              p-id="5330" fill="white"></path>
            <path d="M512 401m-106 0a106 106 0 1 0 212 0 106 106 0 1 0-212 0Z" p-id="5331" fill="white"></path>
            <path d="M514.5 540.8c-105.1 0-195 68.8-231.6 166.2 28.2 27.9 60.4 50.1 95.9 65.9 40.2 18 83 27.1 127.1 27.1s86.9-9.1 127.1-27.1c38.9-17.4 73.8-42.3 103.8-74.1 1.4-1.5 2.7-3 4.1-4.4-39.2-90.6-125.8-153.6-226.4-153.6z" p-id="5332" fill="white"></path>
          </svg>
    ...
    async toDoLogout () {
      ...
      try {
        ...
        if (res.data.code === 1) {
          ...
          sessionStorage.removeItem("navInfo")
