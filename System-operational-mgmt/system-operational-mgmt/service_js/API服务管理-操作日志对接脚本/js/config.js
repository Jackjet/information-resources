...
var config = {
  database: {
    dbUrl: 'jdbc:postgresql://8.140.114.226:5432/user_management',
    dbUser: 'postgres',
    dbPwd: 'Qwer@1234'
  },
  schedule: {
  ...
  other: {
    ...
    systemMonitor: {
      ...
      system: 'API服务管理系统',
      systemId: 'b3b971cd79014d9faf738113dbcb80ff',
      directory: '/data/websites/integration-central/user-management',
      processName: 'user_management'
    }
  }
}
