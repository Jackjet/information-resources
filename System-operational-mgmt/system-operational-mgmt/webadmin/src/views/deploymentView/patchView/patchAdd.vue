<template>
  <el-drawer
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
      ...
      <el-form-item class="InpitWidth" label="补丁号:" prop="versionNumber">
        <el-input clearable autocomplete="off" :disabled="disabled || isUpload" v-model="ruleForm.versionNumber" placeholder="请输入补丁号" @change="versionChange"></el-input>
      </el-form-item>
      <el-form-item class="InpitWidth" label="部署状态:" v-if="id">
        <el-input disabled autocomplete="off" v-model="typeStageText"></el-input>
      </el-form-item>

      <el-form-item label="补丁包:" prop="automatedPackPath">
        ...
        <div v-if="!disabled">
          ...
          >
            ...
            <div slot="tip" class="el-upload__tip" style="color:red;">
              注：上传的补丁包需要是zip格式的完整程序压缩包（该功能用于程序有大版本更新时使用）
            </div>
          </el-upload>
        </div>
      </el-form-item>
...
export default {
  ...
  data () {
    return {
      ...
      fileUrl: process.env.VUE_APP_BASE_API + "/webadmin/service/file/uploadDeploymentFile?type=upgrade",
      header: {
