<template>
  <el-main>
    ...
    <patchAdd :modal-objjj="title" @getList="getList" ref="add"> </patchAdd>
    <deploymentDetalis
      :modal-objjj='title'
      @getList="getList"
      ref="detalis">
...
let myTime = null;
export default {
  components: { TableList, Pagination, patchAdd, deploymentDetalis },
  data() {
    return {
      nodeList: [],
      sysList: [],
    ...
    async getList() {
      ...
      try {
        ...
        res.data.data.content.forEach((item) => {
          item.automatedPackPathDownload = process.env.VUE_APP_FILE_API + item.automatedPackPath + '?type=upgrade'
