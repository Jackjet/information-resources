<template>
  <el-main>
    ...
    <configAdd :modal-objjj="title" @getList="getList" ref="add"> </configAdd>
    <deploymentDetalis
      :modal-objjj='title'
      @getList="getList"
      ref="detalis">
...
let myTime = null;
export default {
  components: { TableList, Pagination, configAdd, deploymentDetalis },
  data() {
    return {
      nodeList: [],
      sysList: [],
    ...
    async getList() {
      ...
      try {
        ...
        res.data.data.content.forEach((item) => {
          item.automatedPackPathDownload = process.env.VUE_APP_FILE_API + item.automatedPackPath + '?type=configUpdate'
