<template>
  <el-drawer
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  v-loading='loading' label-width="120px">
      ...
      <el-form-item label="配置文件:" prop="automatedPackPath">
        ...
        <div v-if="!disabled">
          ...
          >
            ...
            <div slot="tip" class="el-upload__tip" style="color:red;">
              注：上传的配置文件需要是zip格式的完整程序压缩包（该功能用于程序有大版本更新时使用）
            </div>
          </el-upload>
        </div>
      </el-form-item>
      ...
      <el-form-item class="InpitWidth" label="更新说明:">
        <el-input type="textarea" placeholder="请输入更新说明" v-model="ruleForm.remark"></el-input>
      </el-form-item>
    </el-form>
...
export default {
  ...
  data () {
    return {
      ...
      fileUrl: process.env.VUE_APP_BASE_API + "/webadmin/service/file/uploadDeploymentFile?type=configUpdate",
      header: {
