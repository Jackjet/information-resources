  ...
  <el-drawer
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm"  v-loading='loading'>
      ...
      <el-form-item
        ...
        :label-width="this.formLabelWidth"
        class='InpitWidth'>
        <el-select style="width:100%;" clearable v-model="ruleForm.nodeId" :disabled='ProhibitFromm' @change="selectGet" placeholder="请选择节点名称">
          <el-option
       ...
       <el-form-item
        ...
        :label-width="this.formLabelWidth"
        class='InpitWidth'>
        <el-select style="width:100%;" clearable v-model="ruleForm.type" :disabled='ProhibitFromm'  placeholder="请选择数据库类型">
          <el-option
