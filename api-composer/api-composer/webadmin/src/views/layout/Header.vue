<template>
  <div class="theHeader">
    ...
    <div class="right-menu" style="display:flex;">
      <span @click='goBack()' style="margin-right:20px;display:flex;align-items:center;cursor:pointer">
        <img width="30" height="30" src="../../assets/image/back.png" alt="" style="margin-top:-4px;">
        <span style="margin-left:5px;color:#616266">返回首页</span>
      </span>
...
export default {
  ...
  methods: {
    ...
    goBack() {
      ...
      // 正常登录返回首页
      // window.location.href = process.env.VUE_APP_USER_API + '#/navIndex'
    }
  },
  watch: {
    // 监听路由变化
