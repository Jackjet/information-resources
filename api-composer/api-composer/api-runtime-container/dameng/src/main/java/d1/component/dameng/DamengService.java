...
public class DamengService extends BaseNodeService {
    private static final Logger logger = LoggerFactory.getLogger(DamengService.class);
    ...
    private Connection getConnection(String source) throws Exception {
        ...
        String port = Utils.getJsonValue(jsonObject, "port", "5236");
