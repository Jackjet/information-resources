...
import d1.project.d1project.log.dao.OperationLogDao;
import d1.project.d1project.log.entity.OperationLogEntity;
import d1.project.d1project.log.mapper.OperationLogMapper;
import d1.project.d1project.log.model.OperationLogExcel;
import d1.project.d1project.log.model.vm.OperationLogFindAllVm;
...
public class OperationLogServiceImpl implements IOperationLogService {
    ...
    public OperationLogServiceImpl(OperationLogDao userLogDao, MyTokenService myTokenService, WebAdminUserService webAdminUserService) {
    ...
    public void insert(OperationLog model, HttpServletRequest request) throws DoValidException {
        JSONObject userByToken = webAdminUserService.getUserInfo(request);
