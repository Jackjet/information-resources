 ...
 * @since 2020-05-09
 */
public class CataInfoTemp implements Serializable {
    public static final List<String> AUDIT_STATUS_CAN_DELETE = Arrays.asList("0","2","4");
    public static final List<String> AUDIT_STATUS_NO_DELETE = Arrays.asList("1","3");
    private static final long serialVersionUID = 1L;
    @ApiModelProperty("id")
    @TableId(value = "uview_id", type = IdType.AUTO)
