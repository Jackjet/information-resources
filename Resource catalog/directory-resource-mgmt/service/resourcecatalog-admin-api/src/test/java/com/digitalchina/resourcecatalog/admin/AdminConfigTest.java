...
public class AdminConfigTest {
    ...
    public void test() {
        ...
        System.out.println(environment.getProperty("Resourcecatalog.express.appId"));
        ...
        System.out.println(environment.getProperty("logging.level.com.digitalchina.resourcecatalog.admin"));
    }
