<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="['GET /admin/log/list']" class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">查询</el-button>
    </div>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="操作动作" prop="action" show-overflow-tooltip />
      ...
      <el-table-column align="center" label="操作结果" prop="result" show-overflow-tooltip />
      <el-table-column align="center" label="备注信息" prop="comment" show-overflow-tooltip />
