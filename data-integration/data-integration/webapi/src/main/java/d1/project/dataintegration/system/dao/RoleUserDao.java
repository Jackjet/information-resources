...
import d1.project.dataintegration.common.model.IId;
...
public interface RoleUserDao extends JpaRepository<RoleUserEntity, String>, JpaSpecificationExecutor<RoleUserEntity> {
    ...
    @Query(value = "select new d1.project.dataintegration.system.model.vm.WebAdminUserBaseVm(waue.id, waue.name, waue.phone, waue.account, waue.organizationName, waue.roleName) " +
