...
import d1.project.api.integration.system.entity.RoleMenuTreeEntity;
import d1.project.api.integration.system.model.MenuTreeTree;
import d1.project.api.integration.system.model.vm.RoleMenuTreeInsertVm;
...
public class RoleMenuTreeService {
    ...
    public void insert(RoleMenuTreeInsertVm model, HttpServletRequest request) throws DoValidException {
        ...
        for (String menuTreeId : model.getMenuTreeIds()) {
            ...
            BaseUtils.setCreateTimeAndCreateById(request,roleMenuTree);
