package d1.project.api.integration.common;
...
public class Constants {
    ...
    public static String API_STATUS_RELEASE = "1";
    public static String API_STATUS_TO_BE_RELEASED = "0";

    public static String HMAC = "0";
    public static String KEY_AUTH = "1";

    public static String API_GROUP_HAS_CHILDREN = "该分组下存在子节点,无法删除";
}
