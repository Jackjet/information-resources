<template>
  <el-main class="main">
    <el-col :span="24">
      <div v-show="type === 'api'">
        <h3>API名称:{{titleName}}</h3>
      </div>
      <div v-show="type === 'app'">
        <h3>应用名称:{{titleName}}</h3>
      </div>
      <el-form :inline="true" class='el-InputForm'>
        <el-form-item v-if="type === 'api'" label="应用名称:">
          <el-input clearable size="medium" placeholder="请输入应用名称" v-model="SearchItem.appName" icon="el-icon-search">
          </el-input>
        </el-form-item>
        <el-form-item v-if="type === 'app'" label="API名称:">
          <el-input clearable size="medium" placeholder="请输入API名称" v-model="SearchItem.apiName">
          </el-input>
        </el-form-item>
