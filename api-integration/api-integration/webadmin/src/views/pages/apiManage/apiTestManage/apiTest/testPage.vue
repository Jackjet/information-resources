...
<script>
import {historyList,saveApiTestCase,getSign,getApiTestHeader,testCaseList,deleteApiTestLog,deleteApiTestCase,findById,findApiTestCaseById,exportCase,insertTestResult} from "@/api/apiTestManage"
...
export default {
  components:{outerIp,codemirror,axios},
  data() {
    return {
      //容器信息
      container:'',
