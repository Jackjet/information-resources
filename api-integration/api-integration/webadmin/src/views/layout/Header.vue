<template>
  <div class="theHeader">
    ...
    <div class="right-menu" style="display:flex;">
      <span @click='goBack()' style="margin-right:20px;display:flex;align-items:center;cursor:pointer"><img width="30" height="30" style="margin-top:-4px;" src="@/assets/image/home/back.png" alt=""><span style="margin-left:5px;color:#616266">返回首页</span></span>
